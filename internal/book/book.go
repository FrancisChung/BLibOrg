...
// than showing placeholder text), just flagged as incomplete. A manually
// picked destination (CategoryManual) reports Edited the same way a
// manually edited Title/Author/Year field does. Only once all three fields
// are resolved, with no manual category pick, does the status reflect
// Title/Author/Year's own Heuristic/Metadata provenance.
